...
public class BrightnessSliderView extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        mTextPersen = requireViewById(R.id.anci_percentbrightness);    
	    Handler h = new Handler();
        AncientTextBrightness mmk = new AncientTextBrightness(h);
        mmk.AncientObserver();
    ...
    private void ShowingTextBrightness() {
            int showHide = Settings.System.getInt(getContext().getContentResolver(),"ANCIENT_TEXT_BRIGHTNESS", 0);
	    if (showHide == 1) {
    ...
    public class AncientTextBrightness extends ContentObserver {
            public AncientTextBrightness(Handler h) {
            super(h);
            AncientObserver();
            }
            ...
            public void AncientObserver()
            {
                   ContentResolver cr = getContext().getContentResolver();
                   cr.registerContentObserver(Settings.System.getUriFor("ANCIENT_TEXT_BRIGHTNESS"), false, this);  
            }
    }
